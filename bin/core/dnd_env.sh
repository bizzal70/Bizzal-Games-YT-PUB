...
# D&D-specific prompt defaults (empty by default) to avoid inheriting Shadowdark theming.
export BIZZAL_BG_IMAGE_PROMPT_PREFIX="${BIZZAL_DND_BG_IMAGE_PROMPT_PREFIX:-}"
export BIZZAL_BG_IMAGE_PROMPT_SUFFIX="${BIZZAL_DND_BG_IMAGE_PROMPT_SUFFIX:-}"
export BIZZAL_MUSIC_PROMPT_PREFIX="${BIZZAL_DND_MUSIC_PROMPT_PREFIX:-}"
export BIZZAL_MUSIC_PROMPT_SUFFIX="${BIZZAL_DND_MUSIC_PROMPT_SUFFIX:-}"
