...
SYSTEMS = {
    "dnd5e": dict(
        ...
        srd_pdf_path="reference/srd/SRD_CC_v5.2.1.pdf",
    ...
    "shadowdark": dict(
        ...
        active_srd_path="reference/shadowdark/active",
        srd_pdf_path="reference/shadowdark/source_pdfs/Shadowdark_RPG_-_V4-8.pdf",
